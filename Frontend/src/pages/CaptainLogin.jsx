...
function CaptainLogin() {
  ...
  return (
    <div className="ml-5 mr-5 flex flex-col justify-between h-screen">
        ...
        <p className="mt-1 text-center font-semibold"> New here ? <Link to='/captain-signup' className="text-blue-600">Register as a Captain</Link></p>
        </div>
        <div>
            <Link to='/login' className="flex items-center justify-center bg-[#d5622d] text-white mb-5 p-2 w-full font-medium rounded">Sign in as User</Link>
        </div>
    </div>
  )
}
